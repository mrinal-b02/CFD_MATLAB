...
while error > error_req
    ...
    % zeroing pressure correction values everywhere on the grid
...
% map the staggered values to collocated 
for i = 1:n_points
    for j = 1:n_points
